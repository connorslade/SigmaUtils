...
Requires: <kbd>[Minecraft 1.21.1](https://minecraft.wiki/w/Java_Edition_1.21.1)</kbd> <kbd>[Fabric API](https://modrinth.com/mod/fabric-api)</kbd>

SigmaUtils is a utility mod for Minecraft 1.21.1.
